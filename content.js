(async function () {
    ...
    async function uploadAssetImage(image, fileType) {
        ...
        if(!localStorage.getItem('SUI_SA')) alert('message from jeffalo, creator of scratch image uploader:\nthank you so much for using my browser extension, it really means a lot to me. recently the functionality of this tool has been moved to Scratch Addons (scratchaddons.com). Scratch Addons is an all in one tool for scratch, and it includes other neat features, like a hex colour input, onion skinning, pause button and more. i strongly recommend that you install scratch addons and disable this one, as further updates will not be provided here. once again, thank you for using my stuff!')
        localStorage.setItem('SUI_SA', 'true')
